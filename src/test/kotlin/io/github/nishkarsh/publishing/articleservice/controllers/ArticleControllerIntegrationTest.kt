...
class ArticleControllerIntegrationTest {
	...
	internal fun shouldCreateArticle(@Random article: Article) {
		val request = post("/articles/")
			.content(objectMapper.writeValueAsBytes(article.withValidTextFields()))
	...
	internal fun shouldUpdateArticle(@Random article: Article) {
		val articleToInsert = article.withValidTextFields()
			.copy(publishDate = toUtcAndTruncatedToSeconds(article.publishDate))
		val insertedArticle = mongoTemplate.insert<Article>(articleToInsert)
